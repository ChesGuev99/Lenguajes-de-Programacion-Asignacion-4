...
bonita (Conjuncion   prop1 prop2) = showOperador "/\\"   prop1 prop2
bonita (Disyuncion   prop1 prop2) = showOperador "\\/"   prop1 prop2
bonita (Implicacion   prop1 prop2) = showOperador "->"  prop1 prop2
bonita (Equivalencia prop1 prop2) = showOperador "<->" prop1 prop2
